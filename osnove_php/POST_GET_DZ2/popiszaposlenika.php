    ...
    <table>
        ...
        <tbody>
           <?php foreach($podaci as $zaposlenik){
            $upd="<a href='zaposlenik.php?idzap={$zaposlenik["id"]}&action=update'>Ažuriraj</a>";
            $del="<a href='zaposlenik.php?idzap={$zaposlenik["id"]}&action=delete'>Briši</a>";
            $zaposlenikZanimanja="";
            ...
            $datumRod = date("d.m.Y",strtotime($zaposlenik["datumrodjenja"]));
            $datumAzur = date("d.m.Y H:i:s",strtotime($zaposlenik["datumazur"]));
            ?>
            <tr>
                <td><?php echo $zaposlenik["id"]; ?></td>
                <td><?php echo $zaposlenik["ime"]; ?></td>
                <td><?php echo $zaposlenik["prezime"]; ?></td>
                <td><?php echo $datumRod; ?></td>
                ...
                <td><?php echo $datumAzur; ?></td>
                <td><?php echo $upd." | ".$del; ?></td>
            </tr>
           <?php 
        }
        ?>
